...
//This test is for testing the easy questions and inputting a username at the end
@RunWith(AndroidJUnit4.class)
public class EasyQuizTest {
    //Starts on the QuizActivity
    @Rule
    ...
    public void testQuizEasy() {
        ...
        //Waits for the quiz to complete the loop
        for (int i = 0; i < 10; i++) {
